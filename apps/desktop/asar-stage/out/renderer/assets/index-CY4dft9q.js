...
const ipc$2 = () => window.require("electron").ipcRenderer;
function Login({ onDone }) {
  ...
  async function handleLogin(e) {
    ...
    try {
      ...
      if (data.token) {
        setToken(data.token);
        await ipc$2().invoke("config:write", { authToken: data.token });
      }
      onDone();
    } catch (err) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col items-center justify-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex size-12 items-center justify-center rounded-xl bg-primary text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cloud, { size: 24, "aria-hidden": "true" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-3 text-xl font-semibold", children: "Sign in to PC2CLOUD" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Use the same account as the website." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleLogin, className: "mt-6 w-full max-w-xs grid gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LogIn, { size: 17, "aria-hidden": "true" }),
...
const w$1 = window;
const ipc$1 = () => w$1.require("electron").ipcRenderer;
...
function Setup({ onDone }) {
  ...
  const [diskInfo, setDiskInfo] = reactExports.useState(null);
  const [deviceName, setDeviceName] = reactExports.useState("My PC");
  const [error, setError] = reactExports.useState("");
  async function handlePickFolder() {
    try {
      const { ipcRenderer } = w$1.require("electron");
      const dir = await ipcRenderer.invoke("dialog:pick-folder");
      if (!dir) return;
      setSelectedDir(dir);
      const checkDiskSpaceMod = w$1.require("check-disk-space");
  ...
  async function handleSetup(e) {
    ...
    setError("");
    try {
      const nodePath = w$1.require("path");
      const nodeFs = w$1.require("fs");
      const folderPath = nodePath.join(selectedDir, "PC2CLOUD");
      ...
      await ipc$1().invoke("config:write", {
  ...
  const usedPercent = diskInfo ? Math.round((diskInfo.total - diskInfo.free) / diskInfo.total * 100) : 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col justify-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold", children: "Set up your storage" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground mb-6", children: "Choose a folder location for your PC2CLOUD drive." }),
    step === "pick" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { size: 28, className: "text-muted-foreground", "aria-hidden": "true" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: "Choose folder location" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "e.g. D:\\ or C:\\Users\\Name" })
        ]
      }
    ),
    (step === "confirm" || step === "setting-up") && diskInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSetup, className: "grid gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(HardDrive, { size: 20, className: "shrink-0 text-muted-foreground", "aria-hidden": "true" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-sm font-medium", children: selectedDir }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              formatGB(diskInfo.free),
              " free · ",
              formatGB(diskInfo.total),
              " total"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 h-1.5 overflow-hidden rounded-full bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-xs text-muted-foreground", children: [
          "A ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "PC2CLOUD" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: step === "setting-up" ? "Setting up..." : "Start setup"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
    ...
    step === "done" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 py-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex size-14 items-center justify-center rounded-full bg-green-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 28, className: "text-green-600", "aria-hidden": "true" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "All done!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center", children: "Your PC is now connected to PC2CLOUD." })
    ] })
  ] });
}
const w = window;
function Ready({ onDisconnect, syncStatus, lastSyncTime, onSyncNow }) {
  function syncLabel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col items-center justify-center gap-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex size-16 items-center justify-center rounded-full bg-green-50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute size-3 rounded-full bg-green-500 top-0 right-0 animate-pulse" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "🖥️" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold", children: "Your PC is connected" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full max-w-xs flex-col gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { size: 16, "aria-hidden": "true" }),
            "Open Dashboard"
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { size: 16, "aria-hidden": "true" }),
            "Minimize to tray"
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Unplug, { size: 16, "aria-hidden": "true" }),
            "Disconnect this PC"
          ]
        }
      )
...
const STORAGE_SYNC_INTERVAL = 5 * 60 * 1e3;
function App() {
  ...
  const storageSyncRef = reactExports.useRef(null);
  const deviceIdRef = reactExports.useRef("");
  const folderPathRef = reactExports.useRef("");
  const fileSyncBusyRef = reactExports.useRef(false);
  function connectSocket(deviceId) {
    ipc().invoke("socket:connect", deviceId, getToken(), API_URL);
  }
  async function pushStorageUpdate(deviceId, folderPath) {
  ...
  async function pushFileSync(deviceId, folderPath) {
    ...
    try {
      ...
      fileSyncBusyRef.current = false;
    }
  }
  function startStorageSync(deviceId, folderPath) {
  ...
  async function reconnectWithConfig(config) {
  ...
  reactExports.useEffect(() => {
    const w2 = window;
    const nodePath = w2.require("path");
    const nodeFs = w2.require("fs");
    const onSocketEvent = (_, event, data) => {
      const folder = folderPathRef.current;
      if (event === "file:request") {
        const { requestId, filePath } = data;
        if (!folder || !requestId || !filePath) return;
        const resolved = nodePath.resolve(nodePath.join(folder, filePath));
        if (!resolved.startsWith(nodePath.resolve(folder))) return;
        ipc().invoke("file:read", resolved).then((result) => {
          return apiFetch(`${API_URL}/api/transfer/${requestId}`, {
            method: "POST",
            headers: {
          ...
          apiFetch(`${API_URL}/api/transfer/${requestId}/error`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ message: "Could not read file" })
          }).catch(() => {
          });
        });
      }
      if (event === "file:upload") {
        ...
        const resolved = nodePath.resolve(nodePath.join(folder, filePath));
        if (!resolved.startsWith(nodePath.resolve(folder))) return;
        apiFetch(`${API_URL}/api/transfer/${requestId}/content`).then(async (res) => {
          const buf = await res.arrayBuffer();
          nodeFs.mkdirSync(nodePath.dirname(resolved), { recursive: true });
          nodeFs.writeFileSync(resolved, Buffer.from(buf));
          return apiFetch(`${API_URL}/api/transfer/${requestId}/write-done`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ ok: true })
          });
        }).catch(() => {
          apiFetch(`${API_URL}/api/transfer/${requestId}/write-error`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ message: "Could not write file" })
          }).catch(() => {
          });
        });
      }
      if (event === "folder:create") {
        ...
        const resolved = nodePath.resolve(nodePath.join(folder, folderPath));
        if (!resolved.startsWith(nodePath.resolve(folder))) return;
        try {
    ...
    ipc().on("socket:event", onSocketEvent);
    return () => {
      ipc().removeListener("socket:event", onSocketEvent);
    };
  }, []);
  reactExports.useEffect(() => {
    (async () => {
  ...
  function handleSetupDone(deviceId, folderPath) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-col bg-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "drag-region flex h-8 shrink-0 items-center justify-between px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-muted-foreground", children: "PC2CLOUD" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "no-drag flex gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col overflow-hidden px-8 pb-8", children: [
      screen === "loading" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-1 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-6 animate-spin rounded-full border-2 border-primary border-t-transparent" }) }),
      screen === "login" && /* @__PURE__ */ jsxRuntimeExports.jsx(Login, { onDone: handleLoginDone }),
      screen === "setup" && /* @__PURE__ */ jsxRuntimeExports.jsx(Setup, { onDone: handleSetupDone }),
      screen === "ready" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ready,
        {
